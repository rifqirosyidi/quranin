...
const Surat = ({ surat, ayat = 1 }) => {
  return (
    <Link to={`/surat/${surat.slug}/ayat/${ayat}`}>
      <div className="flex flex-col h-full p-4 bg-primary shadow-sm rounded-md dark:bg-gray-700  transition duration-500 cursor-pointer hover:shadow-primary transform hover:-translate-y-2">
